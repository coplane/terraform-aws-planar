...
## Using the module securely

Pin the module to an immutable release, review the Terraform plan before applying upgrades, and use the latest supported release when security fixes are published. Customer-specific security scanning, policy checks, and deployment approvals remain part of the customer-managed Terraform pipeline.
